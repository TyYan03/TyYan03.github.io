...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Tyler Yan',", type: "array-item" },
    ...
    {
      code: '        <Link href="/contact">Contact Me</Link>',
      type: "object-method",
    },
    ...
    <div className={styles.heroLayout}>
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <div className={styles.namePhotoWrapper}>
            <h1 className={styles.developerName}>
              Tyler <span className={styles.accentText}>Yan</span>
            </h1>
            <Image
              src="/profile/TylerYanProfilePhoto.jpg"
              alt="Tyler Yan"
              width={125}
              height={125}
          ...
          <p className={styles.bio}>
            I build reliable and efficient software solutions that solve complex
            problems. From low-level programming to full-stack web development,
            I create systems that combine performance, usability, and
            scalability
          </p>
